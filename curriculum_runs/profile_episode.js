...
const context={console,Math,Date,setInterval,clearInterval,setTimeout,document:{getElementById:elem,createElement:()=>({click(){},remove(){}}),querySelectorAll:()=>[]},body:{appendChild(){}}}; context.Blob=function(){}; context.URL={createObjectURL:()=>'',revokeObjectURL(){}}; context.global=context; vm.createContext(context); vm.runInContext(fs.readFileSync(require('path').join(__dirname,'crane_script.js'),'utf8'),context);
const code=`(()=>{
